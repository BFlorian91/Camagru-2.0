    ...
    <header>
      <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg scrolling-navbar double-nav">
        ...
        <ul class="nav navbar-nav nav-flex-icons ml-auto">
          ...
          <li class="nav-item my-auto">
            <a href="<?= trim($_SESSION['token']) !== '' ? 'user' : 'signin'; ?>" class="nav-link"><i class="text-white fas fa-user icon-effect" style="font-size: 20px;"></i> <span class="clearfix d-none d-sm-inline-block text-white"></span></a>
          </li>
