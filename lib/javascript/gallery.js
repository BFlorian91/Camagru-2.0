  ...
  try {
    ...
    if (response.ok) {
      ...
      for (let i = 0; i < datas.datas.numberOfImages; i++) {
        ...
        pCountLikes.setAttribute('id', 'coucou');
...
let test = document.getElementById('coucou')[0].appendChild(container);
...
const likeCount = document.getElementsByClassName('likesCount')

likeCount[1].value = 52;
